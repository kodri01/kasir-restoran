			...
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					<div class="login100-form-avatar">
						<img src="template/masuk/images/profil.png" alt="AVATAR" style="border-radius: 100px;">
					</div>
					...
					?>
					<br><br><br><br><br>
					<div class="text-center w-full" ><b style="color:aliceblue">Don't have an account ?</b> 
