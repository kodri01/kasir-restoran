...
<body>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="generate_laporan.php" class="visible-phone"><i class="icon icon-print"></i>
        ...
        <ul>
            ...
            <li class="active"> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate
                        Laporan</span></a> </li>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="generate_laporan.php" title="Go to here" class="tip-bottom"><i
                        class="icon icon-print"></i> Generate Laporan</a></div>
        </div>
        <!--End-breadcrumbs-->
