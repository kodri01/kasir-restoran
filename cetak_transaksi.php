...
<body>
    ...
    <page size="dipakai" layout="landscape" style="margin-top: 2rem;">
        <br>
        <?php
        ...
        <center>
            <img src="template/dashboard/img/lg.png">
            <span>
                Jalan Penuh Kenanga No. 99 <br> Komp. Ruko Simp. III Kota Jambi <br> Telp. 0778-4432-76
            </span>
        </center>
        <hr>
        <table class="tabel" style="width: 8cm;">
            <tr>
                <td>
                    Pelanggan
                </td>
        ...
        <div class="container">
            <span>
                <a style="border-radius: 20px;" class="btn btn-success" id="ct"><span class="icon-print"></span>
                    CETAK</a>
            </span>
        </div>
    </page>
