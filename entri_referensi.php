...
<body>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="entri_referensi.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Entri
                Referensi</span></a>
        <ul>
            <?php
                    if ($r['id_level'] == 1) {
            ...
            <li class="active"> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Entri
                        Referensi</span></a> </li>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="entri_referensi.php" title="Go to here" class="tip-bottom"><i
                        class="icon icon-tasks"></i> Entri Referensi</a></div>
        </div>
        <!--End-breadcrumbs-->
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <?php
                        if ($r['id_level'] == 1) {
                        ?>
                <div class="widget-box" style="position: -ms-page;">
                    <div class="widget-title bg_lg"><span class="icon"><i class="icon-th-large"></i></span>
                        <h5>Referensi Makanan</h5>
                        <a href="tambah_menu.php" class="btn btn-info btn-mini label"><i
                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="btn-icon-pg">
                                <ul>
                                    <!--Looping-->
                                    <?php
                                                $query_data_makanan = "select * from tb_minuman order by id_minuman desc";
                                                $sql_data_makanan = mysqli_query($conn, $query_data_makanan);
                                                $no_makanan = 1;
                                                ...
                                                ?>
                                    <li class="span2">
                                        <a> <img src="gambar/<?php echo $r_dt_makanan['gambar_minuman'] ?>" alt=""> </a>
                                        <div class="actions">
                                            <a class="lightbox_trigger"
