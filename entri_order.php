...
<body>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="entri_order.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Entri
                Order</span></a>
        <ul>
            <?php
                    if ($r['id_level'] == 1) {
            ...
            <li class="active"> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Entri
                        Order</span></a> </li>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="entri_order.php" title="Go to here" class="tip-bottom"><i
                        class="icon icon-tasks"></i> Entri Order</a></div>
        </div>
        <!--End-breadcrumbs-->
        ...
        <div class="container-fluid">
                                    ...
                                    <ul>
                                        ...
                                        <?php
                                                        ...
                                                        if (isset($_REQUEST['tambah_pesan'])) {
                                                            ...
                                                            $query_tambah_pesan = "insert into tb_pesan values('', '$id', '', '$id_masakan','$id_minuman', '', '')";
                                ...
                                <div class="btn-icon-pg">
                                    <ul>
                                        ...
                                        <?php
                                                        ...
                                                        while ($r_dt_pesan = mysqli_fetch_array($sql_lihat_pesan)) {
                                                            array_push($pesan, $r_dt_pesan['id_minuman']);
                                                        }

                                                        $query_data_makanan = "select * from tb_minuman where stok > 0 order by id_minuman desc";
                                                        $sql_data_makanan = mysqli_query($conn, $query_data_makanan);
                                                        $no_makanan = 1;
                                                        ...
                                                        ?>
                                        <li class="span2">
                                            <a> <img src="gambar/<?php echo $r_dt_makanan['gambar_minuman'] ?>" alt="">
                                            </a>
                                            <div class="actions">
                                                <a class="lightbox_trigger"
                                                    href="gambar/<?php echo $r_dt_makanan['gambar_minuman']; ?>"><i
                                                        class="icon-search"></i>&nbsp;Lihat</a>
                                            </div>
                                            <table class="table table-bordered">
                                                <tbody>
                                                    <tr>
                                                        <td><?php echo $r_dt_makanan['nama_minuman']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Harga / Porsi</td>
                                                        <td>Rp. <?php echo $r_dt_makanan['harga']; ?>,-</td>
                                            ...
                                            <form action="" method="post">
                                                <?php
                                                                    if (in_array($r_dt_makanan['id_minuman'], $pesan)) {
                                                                    ?>
                                                <button type="submit" value="<?php echo $r_dt_makanan['id_minuman']; ?>"
                                                    name="tambah_pesan2" class="btn btn-danger btn-mini" disabled>
                                                    <i class='icon-shopping-cart'></i>&nbsp;&nbsp;Telah dipesan
                                                    &nbsp;&nbsp;
                                                </button>
                                                <?php
                                                                    ...
                                                                    ?>
                                                <button type="submit" value="<?php echo $r_dt_makanan['id_minuman']; ?>"
                                                    name="tambah_pesan2" class="btn btn-success btn-mini">
                                                    <i class='icon-shopping-cart'></i>&nbsp;&nbsp;Pesan &nbsp;&nbsp;
                                                </button>
                                                <?php
                                                                    }
                                        ...
                                        <?php
                                                        ...
                                                        if (isset($_REQUEST['tambah_pesan2'])) {
                                                            //echo $_REQUEST['hapus_menu'];
                                                            $id_minuman = $_REQUEST['tambah_pesan2'];

                                                            $query_tambah_pesan = "insert into tb_pesan values('', '$id', '', '$id_makanan','$id_minuman', '', '')";
                                                            $sql_tambah_pesan = mysqli_query($conn, $query_tambah_pesan);
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                                        $query_draft_pesan = "select * from tb_pesan left join tb_masakan on tb_pesan.id_masakan = tb_masakan.id_masakan left join tb_minuman on tb_pesan.id_minuman = tb_minuman.id_minuman where id_user = $id and status_pesan != 'sudah'";
                                        ...
                                        <tr class="odd gradeX">
                                            <td><span
                                                    id="<?php echo "nama" . $r_draft_pesan['id_pesan']; ?>"><?php echo $r_draft_pesan['nama_masakan']; ?>
                                                </span><span
                                                    id="<?php echo "nama" . $r_draft_pesan['id_pesan']; ?>"><?php echo $r_draft_pesan['nama_minuman']; ?></span>
                                            </td>
                                            <input id="<?php echo "harga" . $r_draft_pesan['id_pesan']; ?>"
                                                class="span8" type="hidden"
                                                value="<?php echo $r_draft_pesan['harga']; ?>" />
                                            <td>
                                                <center>
                                                    <input id="<?php echo "jumlah" . $r_draft_pesan['id_pesan']; ?>"
                                                        class="span8"
                                                        name="jumlah<?php echo $r_draft_pesan['id_masakan']; ?>"
                                                        name="jumlah<?php echo $r_draft_pesan['id_minuman']; ?>"
            ...
            <?php
                        ...
                        if (isset($_POST['proses_pesan'])) {
                            ...
                            $query_ubah_jumlah = "select * from tb_pesan left join tb_masakan on tb_pesan.id_masakan = tb_masakan.id_masakan left join tb_minuman on tb_pesan.id_minuman = tb_minuman.id_minuman where id_user = $id and status_pesan != 'sudah'";
                            ...
                            while ($r_ubah_jumlah = mysqli_fetch_array($sql_ubah_jumlah)) {
                                ...
                                $tahu2 = $r_ubah_jumlah['id_minuman'];
                                $tempe = $_POST['jumlah' . $tahu];
                                $id_pesan = $r_ubah_jumlah['id_pesan'];
                                $query_stok = "select * from tb_masakan left join tb_minuman on tb_masakan.id_masakan = tb_minuman.id_minuman where id_masakan = $tahu and id_minuman = $tahu2";
                                $sql_stok = mysqli_query($conn, $query_stok);
                                $result_stok = mysqli_fetch_array($sql_stok);
                                $sisa_stok = $result_stok['stok'] - $tempe;
                                //echo $tempe;
                                $query_proses_ubah = "update tb_pesan set jumlah = $tempe, id_order = $id_ordernya where id_masakan = $tahu and id_minuman = $tahu2 and id_user = $id and status_pesan != 'sudah'";
                                $query_kurangi_stok = "update tb_masakan set stok = $sisa_stok where id_masakan = $tahu and id_minuman = $tahu2";
    ...
    <div class="row-fluid">
        <div id="footer" class="span12" style="color: #fff; background-color:#00c6fb; "> <?php echo date('Y'); ?> &copy;
            Restaurant MakananQu </div>
    </div>
