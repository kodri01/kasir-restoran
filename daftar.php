        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input name="nama_user" type="text" class="span11" autocomplete="off" placeholder="Nama Anda" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Username :</label>
              <div class="controls">
                <input name="username" type="text" class="span11" autocomplete="off" placeholder="Username" />
              </div>
            </div>
            <div class="control-group">
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12" style="color: #fff; background-color:#00c6fb; "> <?php echo date('Y'); ?> &copy; Restaurant MakananQu</div>
</div>
<!--end-Footer-part--> 
